...
const SocialMedia = () => {
  return <>
    ...
    <div className="h-full">
      <div className="flex flex-col gap-5 mb-5 px-4 py-4 ">
        <h1 className="text-xl  sm:text-2xl font-roboto font-light text-lime-300">
          Follow My Journey
        </h1>

        <p className="text-sm  sm:text-lg  lg:text-2xl font-roboto font-light ">
      ...
      <div className="flex flex-col gap-10 mb-10 ">
        ...
        <div className="flex flex-row gap-5 px-4">
          <h1 className="text-2xl font-roboto font-light border-r-2 border-lime-300 pr-3">
            Join the Community
          </h1>
