  ...
  return (
    ...
    >
      ...
      */}
      ...
      <div className={`relative z-10 flex flex-col lg:flex-row p-6 sm:p-10 lg:p-12 gap-10 lg:gap-16 items-center ${idx % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'}`}>
  ...
  const portfolio = [
    {
      ...
      description: "A full-stack real-time messaging ecosystem. Features secure authentication, profile management, and instantaneous post interactions wrapped in a premium UI.",
    ...
    },
    {
      ...
      description: "A community-driven platform engineered to facilitate seamless item donations, empowering youth to reduce waste and share resources effectively.",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 relative z-10 max-w-7xl">
        ...
        <FadeIn delay={100} className="text-center mb-20 lg:mb-32">
          ...
          <p className="text-lg sm:text-xl text-neutral-400 max-w-2xl mx-auto font-light leading-relaxed">
            Clean architecture. Exceptional user experiences. Designed and engineered from the ground up.
          </p>
        </FadeIn>
          ...
          <div className="flex flex-col items-center justify-center py-12">
            <div className="flex items-center gap-3 mb-6 px-5 py-2.5 rounded-full bg-white/[0.02] shadow-[inset_0_1px_0_0_rgba(255,255,255,0.05)]">
              <div className="flex gap-1.5">
                ...
                <div className="w-1.5 h-1.5 rounded-full bg-lime-400/70 animate-pulse" style={{ animationDelay: '150ms' }}></div>
                <div className="w-1.5 h-1.5 rounded-full bg-lime-400 animate-pulse" style={{ animationDelay: '300ms' }}></div>
              </div>
            ...
            <p className="text-neutral-500 text-base font-light">
              Currently engineering the next generation of digital products. Stay tuned.
            </p>
          </div>
        </FadeIn>
